 ...
 */
public class ModuleAndDependenciesMavenProjectStub extends MavenProjectStub
{
    ...
    public List getCollectedProjects()
    {
        ...
        projects.add(createModule("module-E"));
        projects.add(createModule("module-B"));
