 ...
 */
public class DiamondDependenciesMavenProjectStub extends MavenProjectStub
{
    ...
    public List getModules()
    {
        ...
        modules.add("module-with-dependencies-A");
        modules.add("module-with-dependencies-B");
    ...
    public List getCollectedProjects()
    {
        ...
        projects.add(createModule("module-with-dependencies-A"));
        projects.add(createModule("module-with-dependencies-B"));
